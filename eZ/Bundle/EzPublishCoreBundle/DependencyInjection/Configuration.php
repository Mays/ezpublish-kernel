...
- If "http" is used, only one Http BAN request will be sent, with X-Cache-Tags header containing tags to ban.
  X-Cache-Tags consists in a Regexp containing tags to ban.
  Examples:
   - (location-123|parent-456|content-789) => Purge cache items with tag location #123, children of location #456 , and content #789.
   - .* => Purge all locations.
